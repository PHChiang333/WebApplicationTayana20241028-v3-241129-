<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBack.Master" AutoEventWireup="true" CodeBehind="WebForm1yachtManageCreate1.aspx.cs" Inherits="WebApplicationTayana20241028.WebForm1yachtManageCreate" %>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="unread">
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxYachtNameTag" runat="server" class="form-control" placeholder="New Design"></asp:TextBox>
                                                <p>(ex: New Design, New Building...)</p>
                                            </td>
                                        </tr>
                                        <tr class="unread">
                                            <td>
                                                <asp:CheckBox ID="CheckBoxAddYachtIsPintop" runat="server" Text="Pintop" />
                                            </td>
                                        </tr>
                                        <tr class="unread">
                                            <td>
                                                <label class="form-label">Description</label>
                                                <asp:TextBox ID="TextBoxAddYachtDesc" runat="server" class="form-control"></asp:TextBox>
                                        ...
                                        <tr class="unread">
                                            <td>
                                                <asp:Button ID="ButtonToNextStep" runat="server" Text="Click to Next Step" OnClick="ButtonToNextStep_Click" />
                                            </td>
                                            <td>
