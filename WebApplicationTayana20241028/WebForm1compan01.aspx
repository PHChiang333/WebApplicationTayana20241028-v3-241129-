<%@ Page Title="" Language="C#" MasterPageFile="~/SiteFronthomestyle.Master" AutoEventWireup="true" CodeBehind="WebForm1compan01.aspx.cs" Inherits="WebApplicationTayana20241028.WebForm1compan011" %>
...
<%--    <div class="bannermasks">
        <img src="tayana/html/images/company.jpg" alt="&quot;&quot;" width="967" height="371" /></div>--%>
    <!--遮罩結束-->
    ...
    <div class="conbg">
        ...
        <div class="left">
            ...
            <div class="left1">
                ...
                <ul>
                    <li><a href="WebForm1compan01.aspx" target="_self">About Us</a></li>

                    <li><a href="WebForm1compan02.aspx" target="_self">Certificat</a></li>
        ...
        <!--------------------------------右邊選單開始---------------------------------------------------->
        <div id="crumb"><a href="#">Home</a> >> <a href="WebForm1compan01.aspx">Company  </a>>> <a href="#"><span class="on1">About Us</span></a></div>
        <div class="right">
            <div class="right1">
                ...
                <div class="box3">
                    ...
                    <p>
                        <img src="tayana/html/images/pit010.jpg" alt="&quot;&quot;" width="274" height="192" /></p>
